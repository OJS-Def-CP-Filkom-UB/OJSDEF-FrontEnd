  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <span
          className={`text-sm font-semibold whitespace-nowrap ${SCAN_STATUS_COLORS[job.status]}`}
        >
      ...
      <div className="glass-dark rounded-xl border border-white/5 p-6 space-y-5">
        ...
        <div className="flex flex-wrap gap-3 pt-2">
          ...
          {cancelError && (
            <p className="text-red-400 text-sm w-full">{cancelError}</p>
          )}
          {isTerminal && (
            <Button
              variant="outline"
          ...
          {job.status === "completed" && (
            <>
              ...
              <Link href={`/export?search=${job.id}`}>
                <Button
                  variant="outline"
